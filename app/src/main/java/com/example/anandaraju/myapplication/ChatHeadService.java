...
public class ChatHeadService extends Service {
    ...
    private String sMsg = "";
    static public int isActiveService=1;
    ...
    private void chathead_click(){
            ...
            Intent it = new Intent(this,Main4Activity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(it);
